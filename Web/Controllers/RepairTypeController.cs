...
public class RepairTypeController : ControllerBase
{
    ...
    public RepairTypeController(IMediator mediator, IAppDbContextProvider dbContextProvider)
    {
        _mediator = mediator;
    ...
    public async Task<IActionResult> Get(int id)
    {
        ...
        var (result, entity) = await _mediator.Send(new GetRepairTypeQuery { Id = id, DbContext = dbContext });
    ...
    public async Task<IActionResult> Update(int id, [FromQuery] UpdateRepairTypeCommand command)
    {
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        var result = await _mediator.Send(new DeleteRepairTypeCommand { Id = id, DbContext = dbContext });
        return result.Succeeded ? Ok() : BadRequest(result);
    }
}