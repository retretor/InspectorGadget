...
public class PartForRepairTypeController : ControllerBase
{
    ...
    public PartForRepairTypeController(IMediator mediator, IAppDbContextProvider dbContextProvider)
    {
        _mediator = mediator;
    ...
    public async Task<IActionResult> Get(int id)
    {
        ...
        var (result, entity) = await _mediator.Send(new GetPartForRepairTypeQuery { Id = id, DbContext = dbContext });
    ...
    [HttpPut("{id}")]
    [RequiresClaim(ClaimTypes.Role, new[] { Role.ADMIN })]
    public async Task<IActionResult> Update(int id, [FromQuery] UpdatePartForRepairTypeCommand command)
    {
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        var result = await _mediator.Send(new DeletePartForRepairTypeCommand { Id = id, DbContext = dbContext });
        return result.Succeeded ? Ok() : BadRequest(result);
    }
}